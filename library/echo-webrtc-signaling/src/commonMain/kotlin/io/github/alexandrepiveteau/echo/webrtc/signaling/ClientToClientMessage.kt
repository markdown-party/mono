 ...
 */
@Serializable
public sealed class ClientToClientMessage {
   ...
   */
  @Serializable public data class Offer(val offer: SessionDescription) : ClientToClientMessage()
   ...
   */
  @Serializable public data class Answer(val answer: SessionDescription) : ClientToClientMessage()
   ...
   */
  @Serializable public data class IceCaller(val ice: IceCandidate) : ClientToClientMessage()
   ...
   * @param ice the [IceCandidate] which is sent.
   */
  @Serializable public data class IceCallee(val ice: IceCandidate) : ClientToClientMessage()
}
