...
internal inline fun packUInts(val1: UInt, val2: UInt): ULong {
...
internal inline fun unpackUInt1(value: ULong): UInt {
  return value.shr(32).toUInt()
}

/** Unpacks the second Int value in [packUInts] from its returned Long. */
internal inline fun unpackUInt2(value: ULong): UInt {
