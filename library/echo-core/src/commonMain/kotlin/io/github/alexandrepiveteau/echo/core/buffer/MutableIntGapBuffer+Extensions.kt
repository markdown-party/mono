...
public fun mutableIntGapBufferOf(): MutableIntGapBuffer = MutableIntGapBufferImpl()
 ...
 */
public fun MutableIntGapBuffer(size: Int): MutableIntGapBuffer {
 ...
 * @throws IllegalArgumentException if the size is negative.
 */
public fun MutableIntGapBuffer(size: Int, init: (Int) -> Int): MutableIntGapBuffer {
