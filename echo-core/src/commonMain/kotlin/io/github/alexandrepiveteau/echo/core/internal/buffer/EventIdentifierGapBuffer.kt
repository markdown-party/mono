...
internal class EventIdentifierGapBuffer {
  ...
  /** Returns an [EventIdentifierArray] that contains a copy of the events from this buffer. */
  fun toArray(): EventIdentifierArray {
    return EventIdentifierArray(size).apply {
